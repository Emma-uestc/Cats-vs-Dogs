...
def run_training():
    ...
    logs_train_dir = 'F:/deepLearningProgramExcise/tensorflow/cats_vs_dogs/cat_vs_dog/logs/train'
...
def get_one_image(train):
    ...
    '''
    n = len(train)
    ind = np.random.randint(0, n) # select an image from train_data
    img_dir = train[ind]
...
def evaluate_one_image():
    ...
    with tf.Graph().as_default():
        ...
        # model.inference() recive a 4D data
...
def evaluate_all_image():
    ...
    # you need to change the directories to yours.
    # 
    test_dir ='F:/deepLearningProgramExcise/tensorflow/cats_vs_dogs/data/test'
    N_CLASSES = 2
    print('-------------------------')
    ...
    logs_train_dir = 'F:/deepLearningProgramExcise/tensorflow/cats_vs_dogs/data/train'
    saver = tf.train.Saver()
